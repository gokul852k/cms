...
//Cheacking the security code
function validateForm() {
    if (captchavalue === document.getElementById("scode").value) {
        document.getElementById("code-error").innerHTML = '';
        return true;
    } else {
        document.getElementById("code-error").innerHTML = '<p class="code-error-p">Wrong Security Code</p>';
        return false;
    }
}